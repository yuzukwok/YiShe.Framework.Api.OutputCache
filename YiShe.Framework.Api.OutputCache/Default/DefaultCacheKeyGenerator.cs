...
namespace YiShe.Framework.Api.OutputCache.Default
{
    public class DefaultCacheKeyGenerator : ICacheKeyGenerator
    {
        ...
        public virtual string MakeCacheKey(HttpActionContext context, MediaTypeHeaderValue mediaType, bool excludeQueryString = false)
        {
            ...
            var key = context.Request.GetConfiguration().CacheOutputConfiguration().MakeBaseCachekey(controller, action, Thread.CurrentPrincipal.Identity.Name);
